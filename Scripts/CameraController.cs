...
namespace Archer
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            Vector3 futurePosition = target.position + (Quaternion.Euler(0, angle, 0)*offset) - (target.forward*distance);
            transform.position = Vector3.Lerp(transform.position, futurePosition, travelTime *Time.deltaTime);
